        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    ...
                    <li class="breadcrumb-item"><a href="{{route('RespondenIndex')}}">Responden</a></li>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="row">
                                            @foreach ($alternatif as $item)
                                                <div class="col-sm-3">
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="checkbox" name="wallet[]" value="{{$item->nama_alternatif}}" id="{{$item->nama_alternatif}}">
                                    ...
                                    <div class="form-row">
                                        <div class="form-group">
                                            ...
                                            <div class="row">
                                                <div class="col-sm-2">
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="radio" name="{{$al->kode_alternatif}}[C05]" id="sangatsetuju" value="5">
                                                        <label class="form-check-label" for="sangatsetuju">
                                                        Sangat Setuju
                                                        </label>
                                                    </div>
